<?php
// On force l'affichage des erreurs pour ne plus avoir de page blanche
...
// --- NOUVELLE REQUÊTE AVEC LA JOINTURE SUR LES PATIENTS ---
$requete = $pdo->query("
    SELECT 
        factures.*, 
...
<table class="table table-hover align-middle">
    ...
    <tbody>
        <?php if (empty($factures)): ?>
            <tr>
                <td colspan="7" class="text-center">Aucune facture pour le moment.</td>
            </tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td><?php echo htmlspecialchars($facture['patient_nom_prenom']); ?></td>
            ...
            <td>
                ...
                if ($statut == 'Impayé') $couleur = 'bg-dark';
                ?>
